...
class QuesadillaTest(unittest.TestCase):
    def setUp(self):
        ...
        self.quesadillaDoble.setTortillas(self.mockedTortilla1 , self.mockedTortilla2)
...
#*************************** COMIENZA QUESADILLA DOBLE ***********************************#
    ...
    def test_quesadillaDoblePerfecta(self) :
        ...
        when(self.mockedTortilla1).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Perfect double quesadilla", self.quesadillaDoble.prepareDouble())
    ...
    def test_quesadillaDobleBuenaTortilla1(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Good double quesadilla toasted2", self.quesadillaDoble.prepareDouble())
    ...
    def test_quesadillaDobleBuenaTortilla2(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Good double quesadilla toasted1", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 1).toast(True)
    ...
    def test_quesadillaDobleRegular(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Regular double quesadilla", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 0).toast(True)
        verify(self.mockedTortilla2, times = 0).toast(True)
        verify(self.mockedQuesoDoble, times = 1).melt(True)
    ...
    def test_quesadillaDobleMala(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Bad double quesadilla", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 1).toast(True)
        verify(self.mockedTortilla2, times = 1).toast(True)
        verify(self.mockedQuesoDoble, times = 1).melt(True)
    ...
    def test_quesadillaDobleTerrible1(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Terrible double quesadilla toasted2", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 0).toast(True)
        verify(self.mockedTortilla2, times = 1).toast(True)
        verify(self.mockedQuesoDoble, times = 1).melt(True)
    ...
    def test_quesadillaDobleTerrible2(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Terrible double quesadilla toasted1", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 1).toast(True)
        verify(self.mockedTortilla2, times = 0).toast(True)
        verify(self.mockedQuesoDoble, times = 1).melt(True)
    ...
    def test_quesadillaDobleNoSeCocino(self) :
        ...
        when(self.mockedQuesoDoble).getCurrentTemperature().thenReturn(2, 8, 8, 8, 14)
        when(self.mockedQuesoDoble).getMeltingTemperature().thenReturn(10)
        self.assertEquals("Not cooked double quesadilla", self.quesadillaDoble.prepareDouble())
        verify(self.mockedTortilla1, times = 0).toast(True)
        verify(self.mockedTortilla2, times = 0).toast(True)
        verify(self.mockedQuesoDoble, times = 1).melt(True)
